...
// consecutive waypoints are real highway driving distances (researched via
// web search, Aug 2026); the 4 flight legs (marked below) are treated as
// instantaneous — 0km, per the One Pager's "fly ✈" transitions.
//
...
const RAW: RawWaypoint[] = [
  ...
  ['nis', 'Nis', 'RS', 163, [43.3209, 21.8958]],
  ['belgrade', 'Belgrade', 'RS', 240, [44.7866, 20.4489]],
  ['zagreb', 'Zagreb', 'HR', 391, [45.815, 15.9819]],
  ['ljubljana', 'Ljubljana', 'SI', 117, [46.0569, 14.5058]],
  ['trieste', 'Trieste', 'IT', 101, [45.6495, 13.7768]],
  // S2 Trieste -> Roma
  ['venezia', 'Venezia', 'IT', 166, [45.4408, 12.3155]],
  ['milano', 'Milano', 'IT', 245, [45.4642, 9.19]],
  ['parma', 'Parma', 'IT', 129, [44.8015, 10.3279]],
  ['modena', 'Modena', 'IT', 63, [44.6471, 10.9252]],
  ['orvieto', 'Orvieto', 'IT', 293, [42.7186, 12.1109]],
  ['roma', 'Roma', 'IT', 122, [41.9028, 12.4964]],
  // S3 Roma -> Marseille
  ['pisa', 'Pisa', 'IT', 362, [43.7228, 10.4017]],
  ['torino', 'Torino', 'IT', 333, [45.0703, 7.6869]],
  ['aix-en-provence', 'Aix-en-Provence', 'FR', 340, [43.5297, 5.4474]],
  ['marseille', 'Marseille', 'FR', 32, [43.2965, 5.3698]],
  // S4 Marseille -> Madrid
  ['arles', 'Arles', 'FR', 94, [43.6766, 4.6278]],
  ['nimes', 'Nimes', 'FR', 32, [43.8367, 4.3601]],
  ['montpellier', 'Montpellier', 'FR', 56, [43.6108, 3.8767]],
  ['perpignan', 'Perpignan', 'FR', 153, [42.6986, 2.8954]],
  ['zaragoza', 'Zaragoza', 'ES', 478, [41.6488, -0.8891]],
  ['madrid', 'Madrid', 'ES', 319, [40.4168, -3.7038]],
  // S5 Madrid -> Porto (POWER 1500)
  ['malaga', 'Malaga', 'ES', 339, [36.7213, -4.4213]],
  ['lisbon', 'Lisbon', 'PT', 655, [38.7223, -9.1393]],
  ['porto', 'Porto', 'PT', 317, [41.1579, -8.6291]],
  // S6 Porto -> Barcelona
  ['mombuey', 'Mombuey', 'ES', 273, [42.0357, -6.3369]],
  ['cembranos', 'Cembranos', 'ES', 100, [42.5167, -5.7833]],
  ['burgos', 'Burgos', 'ES', 175, [42.3439, -3.6969]],
  ['barcelona', 'Barcelona', 'ES', 624, [41.3851, 2.1734]],
  // S7 Barcelona -> Paris
  ['beziers', 'Beziers', 'FR', 252, [43.3444, 3.2158]],
  ['clermont-ferrand', 'Clermont-Ferrand', 'FR', 347, [45.7772, 3.087]],
  ['orleans', 'Orleans', 'FR', 300, [47.9029, 1.9093]],
  ['paris', 'Paris', 'FR', 132, [48.8566, 2.3522]],
  // S8 Paris -> London, then FLIGHT to Quebec City
  ['dover', 'Dover', 'GB', 264, [51.1279, 1.3134]],
  ['portsmouth', 'Portsmouth', 'GB', 172, [50.8198, -1.088]],
  ['southampton', 'Southampton', 'GB', 35, [50.9097, -1.4044]],
  ['birmingham', 'Birmingham', 'GB', 217, [52.4862, -1.8904]],
  ['london', 'London', 'GB', 162, [51.5072, -0.1276]],
  ['quebec', 'Quebec City', 'CA', 0, [46.8139, -71.208]], // FLIGHT (0km) from London
  // S9 Quebec City -> Toronto
  ['sherbrooke', 'Sherbrooke', 'CA', 237, [45.4042, -71.8929]],
  ['montreal', 'Montreal', 'CA', 155, [45.5019, -73.5674]],
  ['ottawa', 'Ottawa', 'CA', 198, [45.4215, -75.6972]],
  ['toronto', 'Toronto', 'CA', 451, [43.6532, -79.3832]],
  // S10 Toronto -> Washington DC (POWER 1500), then FLIGHT to Mexico City
  ['springfield', 'Springfield', 'US', 748, [42.1015, -72.5898]],
  ['providence', 'Providence', 'US', 137, [41.824, -71.4128]],
  ['new-york-city', 'New York City', 'US', 291, [40.7128, -74.006]],
  ['philadelphia', 'Philadelphia', 'US', 156, [39.9526, -75.1652]],
  ['washington-dc', 'Washington DC', 'US', 229, [38.9072, -77.0369]],
  ...
  ['acapulco', 'Acapulco', 'MX', 383, [16.8531, -99.8237]],
  ['veracruz', 'Veracruz', 'MX', 744, [19.1738, -96.1342]],
  // S12 Veracruz -> Ciudad de Guatemala
  ['ciudad-de-guatemala', 'Ciudad de Guatemala', 'GT', 1108, [14.6349, -90.5069]],
  ...
  ['san-salvador', 'San Salvador', 'SV', 292, [13.6929, -89.2182]],
  ['tegucigalpa', 'Tegucigalpa', 'HN', 327, [14.0723, -87.1921]],
  ['managua', 'Managua', 'NI', 375, [12.1364, -86.2514]],
  ['san-jose', 'San Jose', 'CR', 426, [9.9281, -84.0907]],
  // S14 San Jose -> Panama, then FLIGHT to Tulear
  ['panama', 'Panama City', 'PA', 851, [8.9824, -79.5199]],
  ['tulear', 'Tulear', 'MG', 0, [-23.352, 43.6694]], // FLIGHT (0km) from Panama City
  // S15 Tulear -> Toamasina (POWER 1250), then FLIGHT to Ashkelon
  ['antsirabe', 'Antsirabe', 'MG', 776, [-19.8667, 47.0333]],
  ['antananarivo', 'Antananarivo', 'MG', 170, [-18.8792, 47.5079]],
  ['toamasina', 'Toamasina', 'MG', 354, [-18.1497, 49.4023]],
  ...
  ['jerusalem', 'Jerusalem', 'IL', 53, [31.7683, 35.2137]],
  ['eilat', 'Eilat', 'IL', 341, [29.5581, 34.9482]],
  ['beer-sheva', 'Beer Sheva', 'IL', 198, [31.2518, 34.7913]]
